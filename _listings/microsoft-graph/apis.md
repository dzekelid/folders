...
- name: Microsoft Graph API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/folders/master/_listings/microsoft-graph/users-id-|-userprincipalname-mailfolders-id-childfolders-get.md
x-common:
- type: x-change-loge
